...
Note: You may need to artificially generate some IO on a disk/ partition
...
class DiskUsageCollector(diamond.collector.Collector):
    ...
    MAX_VALUES = {
        ...
        'writes':               4294967295,
        'writes_merged':        4924967295,
        'writes_milliseconds':  4924967295,
        'io_milliseconds':      4924967295,
        'io_milliseconds_weighted': 4924967295,
    }
            ...
            try:
                for line in fp:
                    try:
                        ...
                        # On early linux v2.6 versions, partitions 
                        # have only 4 output fields not 11. From linux
                        # 2.6.25 partitions have the full stats set
                        if len(columns) < 14:
                            continue
    ...
    def collect(self):
        ...
        for key, info in results.teritems():
            metrics = {}
            name = info['device']
                ...
                for unit in self.config['byte_unit']:
                    ...
                    if key.endswith('sectors'):
                        ...
                        value = diamond.convertor.binary.convert( 
                            value=value, oldUnit='kB', newUnit=unit)
