...
class rmqHandler(Handler):
    ...
    Sending data to RabitMQ pub/sub channel.
    """
    ...
    def get_config(self):
        """ Get and set config options from configuration file """
    ...
    def get_default_config(self):
        """
        Return the default configuration for this handler
        """
    ...
    def _bind_all(self):
        """
        Bind all RMQ servers defined in external configuration file
        """
